...
export const concerns = [
    ...
    { id: 5, name: "Bowels", image: ConcernImg5, path: "/concern/bowels-yes-no/5" },
    { id: 6, name: "Urination", image: ConcernImg6, path: "/concern/urination-yes-no/6" },
    ...
    { id: 14, name: "Hearing", image: ConcernImg11, path: "/concern/hearing-yes-no/14" },
    { id: 15, name: "Illness", image: ConcernImg12, path: "/concern/illness-yes-no/15" },
    { id: 16, name: "Something Happened", image: ConcernImg13, path: "/concern/something-happened-yes-no/16" },
    { id: 17, name: "Wound / Incision", image: ConcernImg14, path: "/concern/wound-incision-yes-no/17" },
...
export const topicBoard = [
    { id: 1, name: "What Happened to Me?", path: "/topicboard/WhatHappenedtoMe/1" },
    ...
    { id: 10, name: "Feeding Tube", path: "/topicboard/feedingTube/10", secPath: "/feel" },
    { id: 11, name: "Trach", path: "/topicboard/trach/11" },
    { id: 12, name: "Money", path: "/topicboard/money/12" },
    { id: 13, name: "Follow Up Appointment", path: "/topicboard/followUpappointment/13" },
    { id: 14, name: "Household Activity", path: "/topicboard/householdActivity/14" },
    { id: 15, name: "Community Activity", path: "/topicboard/Communityactivity/15" },
