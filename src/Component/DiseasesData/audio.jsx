...
import DoctorFemale from "/assets/audio/English/female/Doctor.mp3";
import WeaknessFemale from "/assets/audio/English/female/Weakness.mp3";
...
import DolorPainSpanishFemale from "/assets/audio/spanish/female/Dolor (Pain).mp3";
...
import NauseasNauseaSpanishFemale from "/assets/audio/spanish/female/Nauseas (Nausea).mp3";
...
import sinPreocupaciones from "/assets/audio/spanish/female/Sin Preocupaciones (No Concerns).mp3";
import comunicacionOPensamiento from "/assets/audio/spanish/female/Comunicacion _ Pensamiento (Communication _ Thinking).mp3";
import movimiento from "/assets/audio/spanish/female/Movimiento (Movement).mp3";
import Pesado_GruesofeMaleSpanish from "/assets/audio/spanish/female/Pesado_Grueso (Heavy_Thick - female).mp3";
import dressingchangeSpanishfeMale from "/assets/audio/spanish/female/Cambio de Vendaje (Dressing Change).mp3";
import InsomnioFemaleSpanish from "/assets/audio/spanish/female/Insomnio (Insomnia).mp3";
import InterrupcionesFemaleSpanish from "/assets/audio/spanish/female/Interrupciones (Interruptions).mp3";
import RevisarMiVisionFemaleSpanish from "/assets/audio/spanish/female/Revisar Mi Vision (Check My Vision).mp3";
import NoPuedoVerIzquierdaFemaleSpanish from "/assets/audio/spanish/female/No Puedo Ver a l Izquierda (Can't See Left).mp3";
import SintomasAccidenteCerebrovascularFemaleSpanish from "/assets/audio/spanish/female/Sintomas de un accidente cerebrovascular (Stroke Symptoms).mp3";
import SinEsperanzaFemaleSpanish from "/assets/audio/spanish/female/Sin Esperanza (Hopeless).mp3";
import TuboAlimentacionRetiradaFemaleSpanish from "/assets/audio/spanish/female/Tubo de Alimentacion Quitado (PEG Removed).mp3";
import SinFrutosSecosFemaleSpanish from "/assets/audio/spanish/female/Sin Fructos Secos (Nut Free).mp3";
import TuboAlimentacionFemaleSpanish from "/assets/audio/spanish/female/Tubo de Alimentación (PEG).mp3";
import DespuesProcedimientoFemaleSpanish from "/assets/audio/spanish/female/Despues de un procedimiento (After Procedure).mp3";
...
import DomingoSundaySpanishFemale from "../../../public/assets/audio/spanish/female/Domingo (Sunday).mp3";
...
// male spanish
// new female audio
import ALittleOffFemale from "/assets/audio/English/newFemaleEnglish/A little off.mp3";
import AbreloPorMiFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Abrelo por mi (Open for me).mp3";
import abrilFemale from "/assets/audio/English/newFemaleEnglish/Abril (April).mp3";
import achingOrDullFemale from "/assets/audio/English/newFemaleEnglish/Aching or Dull.mp3";
import achyFemale from "/assets/audio/English/newFemaleEnglish/Achy.mp3";
import AdjustClothesFemale from "/assets/audio/English/newFemaleEnglish/Adjust Clothes.mp3";
import AfterMealsFemale from "/assets/audio/English/newFemaleEnglish/After Meals.mp3";
import AfterProcedureFemale from "/assets/audio/English/newFemaleEnglish/After Procedure.mp3";
import afternoonFemale from "/assets/audio/English/newFemaleEnglish/afternoon.mp3";
import agostoFemale from "/assets/audio/English/newFemaleEnglish/Agosto (august).mp3";
import AjustarRopaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Ajustar Ropa (Adjust Clothes).mp3";
import AlAcostarseFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Al Acostarse (When Lying Down).mp3";
import AlCaminarFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Al Caminar (When Walking).mp3";
import AlComerBeberFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Al Comer _ Beber (when eating _ drinking).mp3";
import AlDormirFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Al Dormir (When Sleeping).mp3";
...
import allDayFemale from "/assets/audio/English/newFemaleEnglish/All day.mp3";
import AlmohadillaTermicaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Almohadilla Termica (Heating Pad).mp3";
import AlwaysChronicFemale from "/assets/audio/English/newFemaleEnglish/Always _ Chronic.mp3";
import angryFemale from "/assets/audio/English/newFemaleEnglish/angry.mp3";
import anxiousFemale from "/assets/audio/English/newFemaleEnglish/anxious.mp3";
import aprilFemale from "/assets/audio/English/newFemaleEnglish/April.mp3";
import argumentFemale from "/assets/audio/English/newFemaleEnglish/Argument.mp3";
import AsistenteEnfermeriaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Asistente de Enfermeria (Nursing Aide).mp3";
import augustFemale from "/assets/audio/English/newFemaleEnglish/August.mp3";
import AzucarEnSangreFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Azúcar en sangre (Blood Sugar).mp3";

// B files
import badTouchFemale from "/assets/audio/English/newFemaleEnglish/Bad Touch.mp3";
import BajePesoSinIntentarloFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Baje de Peso Sin Intentarlo (Lost Weight Without Trying).mp3";
import BajoSodioFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bajo en Sodio (Low Sodium).mp3";
import BandejaEquivocadaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bandeja Equivocada (Wrong Tray).mp3";
import BanoFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bano (bathroom).mp3";
import BathroomFemale from "/assets/audio/English/newFemaleEnglish/Bathroom .mp3";
import BebidaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bebida (drinks).mp3";
import BedFemale from "/assets/audio/English/newFemaleEnglish/Bed.mp3";
import BienOrEnOrdenFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bien _ En Orden (good _ okay) .mp3";
import BlanketPillowFemale from "/assets/audio/English/newFemaleEnglish/Blanket _ Pillow.mp3";
import BloodPressureFemale from "/assets/audio/English/newFemaleEnglish/Blood Pressure.mp3";
import BloodSugarFemale from "/assets/audio/English/newFemaleEnglish/Blood Sugar.mp3";
import bloodFemale from "/assets/audio/English/newFemaleEnglish/Blood.mp3";
import bloodworkOrXrayFemale from "/assets/audio/English/newFemaleEnglish/Bloodwork or Xray.mp3";
import BlurryFemale from "/assets/audio/English/newFemaleEnglish/Blurry 1.mp3";
import BolsaColostomiaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bolsa de Colostomia _ Ostomia (Colostomy _ Ostomy Bag).mp3";
import BolsaHieloFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Bolsa de Hielo (Ice Pack).mp3";
import bowelsFemale from "/assets/audio/English/newFemaleEnglish/Bowels.mp3";
import BrainFogFemale from "/assets/audio/English/newFemaleEnglish/Brain Fog.mp3";
import BrainTiredFemale from "/assets/audio/English/newFemaleEnglish/Brain Tired.mp3";
import breathingOrCoughingFemale from "/assets/audio/English/newFemaleEnglish/Breathing or Coughing.mp3";
import BreathingTreatmentFemaleEnglish from "/assets/audio/English/newFemaleEnglish/breathing treatment (female english).mp3";
import breathingCoughingFemale from "/assets/audio/English/newFemaleEnglish/Breathing_Coughing female.mp3";
import brownFemale from "/assets/audio/English/newFemaleEnglish/Brown.mp3";
import burningFemale from "/assets/audio/English/newFemaleEnglish/Burning.mp3";

// C files
import callFamilyFemale from "/assets/audio/English/newFemaleEnglish/Call Family.mp3";
import callLightFemale from "/assets/audio/English/newFemaleEnglish/Call Light.mp3";
import CamaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Cama (bed).mp3";
import CambiarRopaInteriorFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Cambia Ropa Interior (Change Underwear).mp3";
import CambiarRopaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Cambiar Ropa (Change Clothes).mp3";
import cantHearFemale from "/assets/audio/English/newFemaleEnglish/can't hear.mp3";
import CantFindMyWordsFemale from "/assets/audio/English/newFemaleEnglish/Can_t Find My Words.mp3";
import CantSeeLeftFemale from "/assets/audio/English/newFemaleEnglish/Can_t See Left.mp3";
...
import ChangeUnderwearFemale from "/assets/audio/English/newFemaleEnglish/Change Underwear.mp3";
import ChargeHearingAidsFemale from "/assets/audio/English/newFemaleEnglish/Charge Hearing Aids.mp3";
import CheckMyHearingFemale from "/assets/audio/English/newFemaleEnglish/Check My Hearing.mp3";
import CheckMyVisionFemale from "/assets/audio/English/newFemaleEnglish/Check my Vision.mp3";
import chestPainFemale from "/assets/audio/English/newFemaleEnglish/chest pain.mp3";
import chillsFemale from "/assets/audio/English/newFemaleEnglish/Chills.mp3";
import chokingFemale from "/assets/audio/English/newFemaleEnglish/Choking.mp3";
import ClumsyOffBalanceFemale from "/assets/audio/English/newFemaleEnglish/Clumsy _ Off Balance.mp3";
import CollarCervicalFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Collar Cervical (Cervical Collar).mp3";
import colorFemale from "/assets/audio/English/newFemaleEnglish/Color.mp3";
import ColostomyOstomyBagFemale from "/assets/audio/English/newFemaleEnglish/Colostomy _ Ostomy Bag.mp3";
import ComerBeberFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Comer _ Beber.mp3";
import ComidaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Comida (food).mp3";
import CommunicationThinkingFemale from "/assets/audio/English/newFemaleEnglish/Communication _ Thinking.mp3";
import CommunicationFemale from "/assets/audio/English/newFemaleEnglish/Communication.mp3";
import CommunityActivityFemale from "/assets/audio/English/newFemaleEnglish/community activity.mp3";
import ComunicacionPensamientoFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Comunicacion _ Pensamiento (Communication _ Thinking).mp3";
import ConActividadMentalFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Actividad Mental.mp3";
import ConAlimentacionTuboFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Alimentacion por Tubo (with tube feed).mp3";
import ConAzucarPresionSangreFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Azucar _ Presion en sangre (with Blood sugar or pressure).mp3";
import ConEstresEmocionFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Estres _ Emocion (with stress _ emotion).mp3";
import HambreSedFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Hambre _ Sed (Hungry _ Thirsty).mp3";
import ConMovimientoFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Movimiento (With Movement).mp3";
import ConSalivaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Con Saliva (with saliva).mp3";
import ConectarTelefonoTabletaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Conectar Telefono _ Tableta (Plug in Phone _ tablet).mp3";
import CongestedOrRunnyNoseFemale from "/assets/audio/English/newFemaleEnglish/Congested or runny nose .mp3";
import CosquilleoGargantaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Cosquilleo en la garganta (tickle in my throat).mp3";
import crampingFemale from "/assets/audio/English/newFemaleEnglish/cramping.mp3";
import crushedFemale from "/assets/audio/English/newFemaleEnglish/crushed.mp3";

// D files

import DebilUnLadoFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Debil de un Lado (Weak on one side).mp3";
import DebilidadFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Debilidad (Weakness).mp3";
import decemberFemale from "/assets/audio/English/newFemaleEnglish/December.mp3";
import DemasiadaLuzFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Demasiada Luz (Too much light).mp3";
import DentadurasFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Dentaduras (Dentures).mp3";
import DenturesFemale from "/assets/audio/English/newFemaleEnglish/Dentures.mp3";
import depressedFemale from "/assets/audio/English/newFemaleEnglish/depressed.mp3";
import DeprimidoTristeFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Deprimido _ Triste (Low _ Sad).mp3";
import DesdeCaidaLesionFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Desde la Caida _ Lesion (Since Fall _ Injury).mp3";
import DesdeEnfermedadFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Desde la enfermedad (Since illness).mp3";
import DesdeDerrameCerebralLesionFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Desde mi derrame cerebral _ lesion (Since stroke _ injury).mp3";
import DespuesComerFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Despues de Comer.mp3";
import despuesDeUnProcedimientoFemale from "/assets/audio/English/newFemaleEnglish/Despues de un procedimiento (After Procedure).mp3";
import DiabeticCarbControlledFemale from "/assets/audio/English/newFemaleEnglish/Diabetic _ Carb-Controlled .mp3";
import diciembreFemale from "/assets/audio/English/newFemaleEnglish/Diciembre (December).mp3";
import DietaEspecialFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Dieta Especial (Special Diet).mp3";
import differentTimesFemale from "/assets/audio/English/newFemaleEnglish/different times.mp3";
import DificilHablarFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Dificil Hablar (Hard to Talk).mp3";
import dificultadParaEscribirFemale from "/assets/audio/English/newFemaleEnglish/Dificultad para Escribir (trouble writing).mp3";
import dificultadParaLeerFemale from "/assets/audio/English/newFemaleEnglish/Dificultad para Leer (trouble reading).mp3";
import DificilEntenderFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Diicil de Entender (Hard to Understand You).mp3";
import dischargeFemale from "/assets/audio/English/newFemaleEnglish/discharge.mp3";
import DoctorFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Doctor (doctor).mp3";
import dolorPainFemale from "/assets/audio/English/newFemaleEnglish/Dolor (Pain).mp3";
import DolorCabezaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Dolor de Cabeza (HEadache).mp3";
import DontWantFemale from "/assets/audio/English/newFemaleEnglish/Don't want.mp3";
import DontEatThisFemale from "/assets/audio/English/newFemaleEnglish/Don_t Eat This.mp3";
import DontKnowWhereIAmFemale from "/assets/audio/English/newFemaleEnglish/Don_t Know Where I Am.mp3";
import doubleFemale from "/assets/audio/English/newFemaleEnglish/Double.mp3";
import DressingChangeFemale from "/assets/audio/English/newFemaleEnglish/Dressing Change.mp3";
import DrinkFemale from "/assets/audio/English/newFemaleEnglish/Drink.mp3";
import drivingFemale from "/assets/audio/English/newFemaleEnglish/Driving.mp3";

import DryMouthFemale from "/assets/audio/English/newFemaleEnglish/dry mouth 1.mp3";

// E files
import EarPainFemale from "/assets/audio/English/newFemaleEnglish/Ear Pain.mp3";
import EatingDrinkingFemale from "/assets/audio/English/newFemaleEnglish/Eating _ Drinking.mp3";
import emotionsOrFeelingsFemale from "/assets/audio/English/newFemaleEnglish/Emotions or Feelings.mp3";
import EmpeoraLargoDiaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Empeora a lo Largo del Día (Gets Worse Through the Day).mp3";
import TardeNocheFemaleSpanish from "/assets/audio/English/newFemaleEnglish/En la Tarde _ la Noche.mp3";
import eneroFemale from "../../../public/assets/audio/English/newFemaleEnglish/Enero (January).mp3";
import EnfermeraFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Enfermera (Nurse).mp3";
import EscribeloFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Escribelo (Write it Down).mp3";
import EstoyConfundidaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Estoy Confundida (I_m Confused).mp3";
import EveningFemale from "/assets/audio/English/newFemaleEnglish/Evening (1).mp3";
import EveningNightFemale from "/assets/audio/English/newFemaleEnglish/Evening _ Night.mp3";
import exhaustedFemale from "/assets/audio/English/newFemaleEnglish/exhausted.mp3";
// F files
import fallFemale from "/assets/audio/English/newFemaleEnglish/Fall .mp3";
import familySupportFemale from "/assets/audio/English/newFemaleEnglish/family support.mp3";
import familyFemale from "/assets/audio/English/newFemaleEnglish/family.mp3";
import fatigueFemale from "/assets/audio/English/newFemaleEnglish/fatigue.mp3";
...
import foodStickingFemale from "/assets/audio/English/newFemaleEnglish/Food Sticking.mp3";
import FoodFemale from "/assets/audio/English/newFemaleEnglish/Food.mp3";
import frequentFemale from "/assets/audio/English/newFemaleEnglish/frequent.mp3";
import fridayFemale from "/assets/audio/English/newFemaleEnglish/Friday.mp3";

// G files
import gasOrBloatingUpdatedFemale from "/assets/audio/English/newFemaleEnglish/Gas or bloating updated.mp3";
import GetsWorseThroughTheDayFemale from "/assets/audio/English/newFemaleEnglish/Gets Worse Through the Day.mp3";
import glassesFemale from "/assets/audio/English/newFemaleEnglish/Glasses.mp3";
import GlutenFreeFemale from "/assets/audio/English/newFemaleEnglish/Gluten Free .mp3";
import GoodOkayFemale from "/assets/audio/English/newFemaleEnglish/Good _ Okay .mp3";
import greenFemale from "/assets/audio/English/newFemaleEnglish/Green.mp3";
import GriefFemale from "/assets/audio/English/newFemaleEnglish/Grief.mp3";

// H files
import HalalFemale from "/assets/audio/English/newFemaleEnglish/Halal (Halal).mp3";
import HardToTalkFemale from "/assets/audio/English/newFemaleEnglish/Hard to Talk .mp3";
import HardToUnderstandYouFemale from "/assets/audio/English/newFemaleEnglish/Hard to Understand You .mp3";
import HeadacheFemale from "/assets/audio/English/newFemaleEnglish/Headache.mp3";
import hearingAidsFemale from "/assets/audio/English/newFemaleEnglish/Hearing Aids.mp3";
import HearingFemale from "/assets/audio/English/newFemaleEnglish/Hearing.mp3";
import heartburnFemale from "/assets/audio/English/newFemaleEnglish/Heartburn.mp3";
import HeatingPadFemale from "/assets/audio/English/newFemaleEnglish/Heating Pad.mp3";
import HeavyThickFemale from "/assets/audio/English/newFemaleEnglish/Heavy _ thick (female - english).mp3";
import heavyFemale from "/assets/audio/English/newFemaleEnglish/Heavy.mp3";
...
// I files
import IcePackFemale from "/assets/audio/English/newFemaleEnglish/Ice Pack.mp3";
import IceFemale from "/assets/audio/English/newFemaleEnglish/Ice.mp3";
import iDontKnowFemale from "/assets/audio/English/newFemaleEnglish/I don't know.mp3";
import illnessFemale from "/assets/audio/English/newFemaleEnglish/Illness.mp3";
import informationFemale from "/assets/audio/English/newFemaleEnglish/information.mp3";
import InhaladorOrTratamientoRespiratorioFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Inhalador _Tratamiento Respiratorio (Inhaler _ Breathing Treatment).mp3";
import InhalerBreathingTreatmentFemale from "/assets/audio/English/newFemaleEnglish/Inhaler _ Breathing Treatment.mp3";
import InodoroOrUrinarioFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Inodoro _ Urinario (Toilet _ Urinal).mp3";
import InsomniaFemale from "/assets/audio/English/newFemaleEnglish/Insomnia.mp3";
import insomnioFemale from "/assets/audio/English/newFemaleEnglish/Insomnio (Insomnia).mp3";
import interrupcionesFemale from "/assets/audio/English/newFemaleEnglish/Interrupciones (Interruptions).mp3";
import InterruptionsFemale from "/assets/audio/English/newFemaleEnglish/Interruptions.mp3";
import itchingFemale from "/assets/audio/English/newFemaleEnglish/itching.mp3";
import ItchyFemale from "/assets/audio/English/newFemaleEnglish/itchy (female english).mp3";
import ImConfusedFemale from "/assets/audio/English/newFemaleEnglish/I_m Confused.mp3";

// J files
import januaryFemale from "/assets/audio/English/newFemaleEnglish/January.mp3";
import julioFemale from "/assets/audio/English/newFemaleEnglish/Julio (July).mp3";
import julyFemale from "/assets/audio/English/newFemaleEnglish/July.mp3";
import juneFemale from "/assets/audio/English/newFemaleEnglish/June.mp3";
import junioFemale from "/assets/audio/English/newFemaleEnglish/Junio (June).mp3";
import JustDryUncomfortableFemale from "/assets/audio/English/newFemaleEnglish/Just Dry _ Uncomfortable.mp3";
import JustFatigueFemale from "/assets/audio/English/newFemaleEnglish/Just Fatigue.mp3";
import JustNauseaFemale from "/assets/audio/English/newFemaleEnglish/Just Nausea.mp3";
import justStartedFemale from "/assets/audio/English/newFemaleEnglish/Just started.mp3";
import JustSwallowingFemale from "/assets/audio/English/newFemaleEnglish/Just Swallowing .mp3";
...
import liquidFemale from "/assets/audio/English/newFemaleEnglish/liquid.mp3";
import llamaLaFamiliaFemale from "/assets/audio/English/newFemaleEnglish/Llama la Familia (Call my Family).mp3";
import LostWeightWithoutTryingFemale from "/assets/audio/English/newFemaleEnglish/Lose Weight Without Trying.mp3";
import LostGlassesFemale from "/assets/audio/English/newFemaleEnglish/Lost Glasses.mp3";
import LostHearingAidsFemale from "/assets/audio/English/newFemaleEnglish/Lost Hearing Aids.mp3";
import LowSodiumFemale from "/assets/audio/English/newFemaleEnglish/Low Sodium .mp3";
import LowSadFemale from "/assets/audio/English/newFemaleEnglish/Low _ Sad.mp3";
import LucesFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Luces (Lights).mp3";
import luzDeLlamadaFemale from "/assets/audio/English/newFemaleEnglish/Luz de Llamada (call light).mp3";

// M files
import MantaAlmohadaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Manta _ Almohada (Blanket _ Pillow).mp3";
...
import MedicationAllergyFemale from "/assets/audio/English/newFemaleEnglish/Medication Allergy .mp3";
import MemoryTroubleFemale from "/assets/audio/English/newFemaleEnglish/Memory Trouble.mp3";
import mildFemale from "/assets/audio/English/newFemaleEnglish/Mild.mp3";
import moderateFemale from "/assets/audio/English/newFemaleEnglish/Moderate.mp3";
import mondayFemale from "/assets/audio/English/newFemaleEnglish/Monday.mp3";
import moneyFemale from "/assets/audio/English/newFemaleEnglish/Money.mp3";
import monthFemale from "/assets/audio/English/newFemaleEnglish/Month.mp3";
import moreThanUsualFemale from "/assets/audio/English/newFemaleEnglish/more than usual.mp3";
import morningFemale from "/assets/audio/English/newFemaleEnglish/Morning.mp3";
import MovementFemale from "/assets/audio/English/newFemaleEnglish/Movement.mp3";
import MovimientoFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Movimiento (Movement).mp3";
import mucousOrSecretionsFemale from "/assets/audio/English/newFemaleEnglish/mucous or secretions.mp3";
import MusicFemale from "/assets/audio/English/newFemaleEnglish/Music.mp3";
...
import NeedMyGlassesFemale from "/assets/audio/English/newFemaleEnglish/Need My Glasses.mp3";
import NeedMyHearingAidsFemale from "/assets/audio/English/newFemaleEnglish/Need My Hearing Aids.mp3";
...
import NoSeDondeEstoyFemaleSpanish from "/assets/audio/English/newFemaleEnglish/No Se Donde Estoy (Don_t Know Where I Am).mp3";
import NoPermitidoComerBeberFemaleSpanish from "/assets/audio/English/newFemaleEnglish/No se Permite Comer _ Beber.mp3";
import NoVoiceFemale from "/assets/audio/English/newFemaleEnglish/No Voice.mp3";
import NoisyFemale from "/assets/audio/English/newFemaleEnglish/Noisy .mp3";
import NotAllowedToEatOrDrinkFemale from "/assets/audio/English/newFemaleEnglish/Not Allowed to Eat _ Drink.mp3";
import NotGoodFemale from "/assets/audio/English/newFemaleEnglish/Not Good.mp3";
import NotWorkingBrokenFemale from "/assets/audio/English/newFemaleEnglish/Not Working _ Broken.mp3";
import novemberFemale from "/assets/audio/English/newFemaleEnglish/November.mp3";
import noviembreFemale from "/assets/audio/English/newFemaleEnglish/Noviembre.mp3";
import nowFemale from "/assets/audio/English/newFemaleEnglish/Now (female).mp3";
import numbOrTingling1Female from "/assets/audio/English/newFemaleEnglish/Numb or tingling (1).mp3";
import numbOrTinglingFemale from "/assets/audio/English/newFemaleEnglish/Numb or tingling.mp3";
import npoFemale from "/assets/audio/English/newFemaleEnglish/NPO.mp3";
import NurseFemale from "/assets/audio/English/newFemaleEnglish/Nurse.mp3";
import NursingAideFemale from "/assets/audio/English/newFemaleEnglish/Nursing Aide.mp3";
import NutFreeFemale from "/assets/audio/English/newFemaleEnglish/Nut Free.mp3";

// O files
import OccupationalPhysicalTherapistFemale from "/assets/audio/English/newFemaleEnglish/Occupational _ Physical Therapist.mp3";
import octoberFemale from "/assets/audio/English/newFemaleEnglish/October.mp3";
import octubreFemale from "/assets/audio/English/newFemaleEnglish/Octubre.mp3";
import OpenForMeFemale from "/assets/audio/English/newFemaleEnglish/Open For Me.mp3";

// P files
import PainMedsFemale from "/assets/audio/English/newFemaleEnglish/Pain Meds.mp3";
...
import ReflujoFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Reflujo (reflux).mp3";
import RefluxFemale from "/assets/audio/English/newFemaleEnglish/Reflux.mp3";
import ReposicionarFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Reposicionar (reposition).mp3";
import RepositionFemale from "/assets/audio/English/newFemaleEnglish/Reposition.mp3";
import RespiratoryTherapistFemale from "/assets/audio/English/newFemaleEnglish/Respiratory Therapist.mp3";
...
import scheduledPainMedsFemale from "/assets/audio/English/newFemaleEnglish/scheduled pain meds.mp3";
import septemberFemale from "/assets/audio/English/newFemaleEnglish/September.mp3";
import septiembreFemale from "/assets/audio/English/newFemaleEnglish/Septiembre (September).mp3";
...
import SoreThroatFemale from "/assets/audio/English/newFemaleEnglish/Sore Throat.mp3";
import spasmingFemale from "/assets/audio/English/newFemaleEnglish/Spasming.mp3";
import SpecialDietFemale from "/assets/audio/English/newFemaleEnglish/Special Diet.mp3";
import SpeechTherapistFemale from "/assets/audio/English/newFemaleEnglish/Speech Therapist.mp3";
import spreadOutFemale from "/assets/audio/English/newFemaleEnglish/Spread out.mp3";
import StitchesOrStaplesWavFemale from "/assets/audio/English/newFemaleEnglish/Stitches or Staples.mp3";
import strokePreventionFemale from "/assets/audio/English/newFemaleEnglish/stroke prevention.mp3";
import suctionFemale from "/assets/audio/English/newFemaleEnglish/suction.mp3";
import sundayFemale from "/assets/audio/English/newFemaleEnglish/Sunday.mp3";
import swallowingFemale from "/assets/audio/English/newFemaleEnglish/Swallowing.mp3";
...
import throbbingFemale from "/assets/audio/English/newFemaleEnglish/Throbbing.mp3";
import thursdayFemale from "/assets/audio/English/newFemaleEnglish/Thursday.mp3";
import TickleInMyThroatFemale from "/assets/audio/English/newFemaleEnglish/Tickle in my Throat.mp3";
import timingFemale from "/assets/audio/English/newFemaleEnglish/timing.mp3";
import TissueFemale from "/assets/audio/English/newFemaleEnglish/Tissue.mp3";
import ToiletUrinalFemale from "/assets/audio/English/newFemaleEnglish/Toilet _ Urinal.mp3";
import tooLittleFemale from "/assets/audio/English/newFemaleEnglish/Too little.mp3";
import TooMuchLightFemale from "/assets/audio/English/newFemaleEnglish/Too Much Light.mp3";
import TooMuchFemale from "/assets/audio/English/newFemaleEnglish/too much.mp3";
import TorpeSinEquilibrioFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Torpe _ Sin Equilibrio (Clumsy _ Off Balance).mp3";
import TrachRemovedFemale from "/assets/audio/English/newFemaleEnglish/Trach Removed.mp3";
import TrachFemale from "/assets/audio/English/newFemaleEnglish/trach.mp3";
import traqueotomiaTrachFemale from "/assets/audio/English/newFemaleEnglish/traqueotomia (trach).mp3";
import troubleReadingFemale from "/assets/audio/English/newFemaleEnglish/Trouble Reading.mp3";
import troubleSleepingFemale from "/assets/audio/English/newFemaleEnglish/trouble sleeping.mp3";
import TroubleWalkingFemale from "/assets/audio/English/newFemaleEnglish/Trouble Walking.mp3";
import troubleWritingFemale from "/assets/audio/English/newFemaleEnglish/Trouble Writing.mp3";
import FeedingTubeFemale from "/assets/audio/English/newFemaleEnglish/Tubo de Alimentacion (Feeding Tube).mp3";
import FeedingTubeRemovedFemale from "/assets/audio/English/newFemaleEnglish/Tubo de Alimentacion Retirada.mp3";
import tuesdayFemale from "/assets/audio/English/newFemaleEnglish/Tuesday.mp3";
import TVFemale from "/assets/audio/English/newFemaleEnglish/TV.mp3";

// U files
import UnPocoRaroFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Un Poco Raro (A little off).mp3";
import urgencyFemale from "/assets/audio/English/newFemaleEnglish/Urgency.mp3";
import urinationFemale from "/assets/audio/English/newFemaleEnglish/Urination.mp3";

// V files
import VegetarianVeganFemale from "/assets/audio/English/newFemaleEnglish/Vegetarian _ Vegan.mp3";
import VegetarianaVeganaFemaleSpanish from "/assets/audio/English/newFemaleEnglish/Vegetariana _ Vegana (Vegetarian _ Vegan).mp3";
import VeryDownFemale from "/assets/audio/English/newFemaleEnglish/Very Down.mp3";
import veryLittleOrInfrequentFemale from "/assets/audio/English/newFemaleEnglish/Very Little or Infrequent.mp3";
import verySevereFemale from "/assets/audio/English/newFemaleEnglish/Very Severe.mp3";
import VisionFemale from "/assets/audio/English/newFemaleEnglish/Vision.mp3";
...
import whatHappenedToMeFemale from "/assets/audio/English/newFemaleEnglish/What happened to me_.mp3";
import WhenEatingDrinkingFemale from "/assets/audio/English/newFemaleEnglish/When Eating _ Drinking.mp3";
import WhenLyingDownFemale from "/assets/audio/English/newFemaleEnglish/When Lying Down.mp3";
import WhenSleepingFemale from "/assets/audio/English/newFemaleEnglish/When Sleeping.mp3";
import WhenSwallowingFemale from "/assets/audio/English/newFemaleEnglish/When Swallowing.mp3";
import WhenToiletingFemale from "/assets/audio/English/newFemaleEnglish/When Toileting.mp3";
import WhenWalkingFemale from "/assets/audio/English/newFemaleEnglish/When Walking.mp3";
import whiteFemale from "/assets/audio/English/newFemaleEnglish/White.mp3";
import wholeFemale from "/assets/audio/English/newFemaleEnglish/whole.mp3";
import willIGetBetterFemale from "/assets/audio/English/newFemaleEnglish/Will I get better_.mp3";
import withBloodPressureFemale from "/assets/audio/English/newFemaleEnglish/With Blood Pressure.mp3";
import withBloodSugarPressureFemale from "/assets/audio/English/newFemaleEnglish/With Blood Sugar _ Pressure.mp3";
import withBloodSugarFemale from "/assets/audio/English/newFemaleEnglish/With Blood Sugar.mp3";
import withDrinksFemale from "/assets/audio/English/newFemaleEnglish/With Drinks.mp3";
import withFoodndDrinkFemale from "/assets/audio/English/newFemaleEnglish/With food and drink.mp3";
import WithFoodFemale from "/assets/audio/English/newFemaleEnglish/With Food.mp3";
import withMedicationFemale from "/assets/audio/English/newFemaleEnglish/With medication.mp3";
import WithMentalActivityFemale from "/assets/audio/English/newFemaleEnglish/With Mental Activity.mp3";
import WithMovementFemale from "/assets/audio/English/newFemaleEnglish/With Movement.mp3";
import withPillsFemale from "/assets/audio/English/newFemaleEnglish/With Pills.mp3";
import WithSalivaFemale from "/assets/audio/English/newFemaleEnglish/With Saliva.mp3";
import WithStressEmotionFemale from "/assets/audio/English/newFemaleEnglish/With Stress _ Emotion.mp3";
import WithTransferRepositioningFemale from "/assets/audio/English/newFemaleEnglish/With Transfer _ Repositioning.mp3";
import WithTubeFeedFemale from "/assets/audio/English/newFemaleEnglish/With Tube Feed.mp3";
import withFemale from "/assets/audio/English/newFemaleEnglish/With....mp3";
import workFemale from "/assets/audio/English/newFemaleEnglish/Work.mp3";
import WorriedGuiltyFemale from "/assets/audio/English/newFemaleEnglish/Worried _ Guilty.mp3";
import worstPainImaginableFemale from "/assets/audio/English/newFemaleEnglish/Worst Pain Imaginable.mp3";
import woundIncisionFemale from "/assets/audio/English/newFemaleEnglish/Wound_Incision.mp3";
import WriteItDownFemale from "/assets/audio/English/newFemaleEnglish/Write It Down.mp3";
import WrongTrayFemale from "/assets/audio/English/newFemaleEnglish/Wrong Tray .mp3";
import WrongWordsComeOutFemale from "/assets/audio/English/newFemaleEnglish/Wrong Words Come Out.mp3";

// Y files
import YellowFemale from "/assets/audio/English/newFemaleEnglish/Yellow .mp3";
...
import No_male from "/assets/audio/English/newFemaleEnglish/No-male.mp3";
import No_no_maleSpanish from "/assets/audio/English/newFemaleEnglish/No_no.mp3";
...
import TraqueotomiaSpanishMale from "/assets/audio/spanish/male/Traqueotomia (Trach).mp3";
import trachMale from "/assets/audio/English/newFemaleEnglish/trachMale.mp3";
import AlgomasMale from "/assets/audio/spanish/male/algo paso.mp3";


import WorstPainImaginableMale from "/assets/audio/English/male/Worst Pain Imaginable_com Male.mp3";
...
import EveningMale from "/assets/audio/English/male/Evening.mp3";
...
import NauseaEnglishFemale from "/assets/audio/English/female/Nausea.mp3";
...
import TerapeutaRespiratorioMale from "/assets/audio/English/newFemaleEnglish/121 Terapeuta respiratorio.mp3";
import CateterMale from "/assets/audio/English/newFemaleEnglish/Cateter (Catheter).mp3";
...
import SuccionSuctionMale from "/assets/audio/English/newFemaleEnglish/succion_suction.mp3";
...
import SalgaPorFavorMale from "/assets/audio/English/newFemaleEnglish/VO - Salga, por favor.mp3";
import PleaseLeaveMale from "/assets/audio/English/newFemaleEnglish/Please Leave (male eng).mp3";
import LlamaALaFamiliaMale from "/assets/audio/English/newFemaleEnglish/Apoyo de la familia v2.mp3";
import CallFamilyMale from "/assets/audio/English/newFemaleEnglish/Call Family (male eng).mp3";
import LuzDeLlamadaMale from "/assets/audio/English/newFemaleEnglish/VO - Luz de Llamada.mp3";
import CallLightMale from "/assets/audio/English/newFemaleEnglish/Call Light (male eng).mp3";
import AudifonosMale from "/assets/audio/English/newFemaleEnglish/Audifonos.mp3";
...
import GlassesGafasMale from "/assets/audio/English/newFemaleEnglish/glasses_gafas.mp3";
...
import NecesitaCambioMale from "/assets/audio/English/newFemaleEnglish/7 Necesita cambio.mp3";
...
import NauseaorvomitingFemale from "/assets/audio/English/female/Nausea or Vomiting.mp3";

import NauseasVomitosNauseaVomitingSpanishFemale from "/assets/audio/English/newFemaleEnglish/Náuseas_Vómitos (Nausea_Vomiting).mp3";
import AdoloridoAAcheySpanishFemale from "/assets/audio/English/newFemaleEnglish/Adolorido_a (Achy).mp3";
import DolorDeGargantaSoreThroatSpanishFemale from "/assets/audio/English/newFemaleEnglish/dolor de garganta.mp3";

import EscalofriosChillsSpanishFemale from "/assets/audio/English/newFemaleEnglish/escalofríos (chills).mp3";
...
import InfectionEnglishFemale from "/assets/audio/English/newFemaleEnglish/Infection.mp3";
...
import Doorfemale from "/assets/audio/English/female/Door.mp3";
import LapuerteFemale from "/assets/audio/English/female/la puerta (door).mp3";
import SharporstabbingEnglishFemale from "/assets/audio/English/female/Sharp or stabbing.mp3";


import withMedicationHowOften from "/assets/audio/English/female/With medication.mp3";
import ringing from "/assets/audio/English/female/Ringing.mp3";
import eatingDrinking from "/assets/audio/English/female/Eating _ Drinking.mp3";
import noConcerns from "/assets/audio/English/female/No Concerns.mp3";

import communicationThinking from "/assets/audio/English/female/Communication _ Thinking.mp3";
import movement from "/assets/audio/English/female/Movement.mp3";
...
import cabeza_head from "/assets/audio/Female-body-audio/English/cabeza_head.mp3";
...
import Shoulder from "/assets/audio/Female-body-audio/English/Shoulder.mp3";
...
import Abdomen_abdomenFemaleSpanish from "/assets/audio/Female-body-audio/spanish/Abdomen_abdomen.mp3";
...
import Las_nalgasFemaleSpanish from "/assets/audio/Female-body-audio/spanish/Las nalgas.mp3";
...
import Cheeks_comMale from "/assets/audio/Male-body-audio/English/Cheeks_com.mp3";
import chestOrBreastsMale from "/assets/audio/Male-body-audio/English/chest or breasts.mp3";
import ChinMale from "/assets/audio/Male-body-audio/English/Chin.mp3";
import EarMale from "/assets/audio/Male-body-audio/English/Ear.mp3";
import Elbow_comMale from "/assets/audio/Male-body-audio/English/Elbow_com.mp3";
import EyeMale from "/assets/audio/Male-body-audio/English/Eye.mp3";
import FingersMale from "/assets/audio/Male-body-audio/English/Fingers.mp3";
import FootOrToes_comMale from "/assets/audio/Male-body-audio/English/Foot or Toes_com.mp3";
import Forearm_comMale from "/assets/audio/Male-body-audio/English/Forearm_com.mp3";
import Forehead_comMale from "/assets/audio/Male-body-audio/English/Forehead_com.mp3";
...
import MouthMale from "/assets/audio/Male-body-audio/English/Mouth.mp3";
import neckMale from "/assets/audio/Male-body-audio/English/neck.mp3";
import NoseMale from "/assets/audio/Male-body-audio/English/Nose.mp3";
import PelvisOrGenitals_comMale from "/assets/audio/Male-body-audio/English/Pelvis or Genitals_com.mp3";
import ShoulderMale from "/assets/audio/Male-body-audio/English/Shoulder.mp3";
import Thigh_comMale from "/assets/audio/Male-body-audio/English/Thigh_com.mp3";
import UpperArmMale from "/assets/audio/Male-body-audio/English/Upper Arm.mp3";
...
import SeptiembreSeptemberSpanishMale from "/assets/audio/spanish/male/VO - Septiembre.mp3";
...
import ViernesFridaySpanishMale from "../../../public/assets/audio/spanish/male/Viernes.mp3";
import TragarSpanishMale from "/assets/audio/spanish/male/Tragar (male).mp3";
import AbrilAprilSpanishMale from "../../../public/assets/audio/spanish/male/VO - Abril.mp3";
import AgostoAugustSpanishMale from "../../../public/assets/audio/spanish/male/VO - Agosto.mp3";
import DiciembreDecemberSpanishMale from "../../../public/assets/audio/spanish/male/VO - Diciembre.mp3";
import DomingoSundaySpanishMale from "../../../public/assets/audio/spanish/male/Domingo.mp3";
import EneroJanuarySpanishMale from "../../../public/assets/audio/spanish/male/Enero (January).mp3";
import FebreroFebruarySpanishMale from "../../../public/assets/audio/spanish/male/VO - Febrero.mp3";
import HoyTodaySpanishMale from "/assets/audio/spanish/male/Hoy - today.mp3";
import JuevesThursdaySpanishMale from "../../../public/assets/audio/spanish/male/Jueves.mp3";
import JulioJulySpanishMale from "../../../public/assets/audio/spanish/male/VO - Julio.mp3";
import JunioJuneSpanishMale from "../../../public/assets/audio/spanish/male/VO - Junio.mp3";
import LunesMondaySpanishMale from "/assets/audio/spanish/male/Lunes.mp3";
import MartesTuesdaySpanishMale from "../../../public/assets/audio/spanish/male/Martes.mp3";
import MarzoMarchSpanishMale from "../../../public/assets/audio/spanish/male/VO - Marzo.mp3";
import MayoMaySpanishMale from "../../../public/assets/audio/spanish/male/VO - Mayo.mp3";
import MiercolesSpanishMale from "../../../public/assets/audio/spanish/male/Miercoles.mp3";
import NoviembreSpanishMale from "../../../public/assets/audio/spanish/male/VO - Noviembre.mp3";
import NowSpanishMale from "/assets/audio/spanish/male/now (male) .mp3";
import OctubreSpanishMale from "../../../public/assets/audio/spanish/male/VO - Octubre.mp3";
import SabadoSaturdaySpanishMale from "../../../public/assets/audio/spanish/male/Sabado.mp3";
// male auido
import WithSalivaMale from "/assets/audio/English/male/1 With Saliva.mp3";
import ToiletUrinalMale from "/assets/audio/English/male/10 Toilet _ Urinal.mp3";
import InsomniaMale from "/assets/audio/English/male/11 Insomnia.mp3";
import NoisyMale from "/assets/audio/English/male/12 Noisy.mp3";
import TooMuchLight from "/assets/audio/English/male/13 Too Much Light.mp3";
import InterruptionsMale from "/assets/audio/English/male/14 Interruptions.mp3";
import LostGlassesMale from "/assets/audio/English/male/15 Lost Glasses.mp3";
import NotWorkingOrBrokenMale from "/assets/audio/English/male/16 Not Working or Broken.mp3";
import NeedMyGlassesMale from "/assets/audio/English/male/17 Need My Glasses.mp3";
import CheckMyVisionMale from "/assets/audio/English/male/18 Check My Vision.mp3";
import JustDryOrUncomfortableMale from "/assets/audio/English/male/2 Just Dry or Uncomfortable.mp3";
import JustSwallowingMale from "/assets/audio/English/male/3 Just Swallowing.mp3";
import MedicationAllergyMale from "/assets/audio/English/male/4 Medication Allergy.mp3";
import RefluxMale from "/assets/audio/English/male/5 Reflux.mp3";
import FeedingTubeMale from "/assets/audio/English/male/6 Feeding Tube.mp3";
...
import SoloAlTragarSpanishMale from "/assets/audio/English/male/3 Solo al tragar.mp3";
...
import TooMuchMale from "/assets/audio/English/male/Too Much.mp3";
...
import CantHearMale from "../../../public/assets/audio/English/male/can't hear.mp3";
...
import GriefMale from "/assets/audio/English/male/Grief.mp3";
...
import FeedingTubeEnglishMale from "/assets/audio/English/male/6 Feeding Tube.mp3";
...
import ColostomyOstomyBagMale from "/assets/audio/English/male/09 Colostomy or Ostomy Bag.mp3";
import HopelessMale from "/assets/audio/English/male/36 Hopeless.mp3";
import TVMale from "/assets/audio/English/male/100 TV.mp3";
import MusicMale from "/assets/audio/English/male/101 Music.mp3";
import DenturesMale from "/assets/audio/English/male/102 Dentures.mp3";
import ChangeClothesMale from "/assets/audio/English/male/103 Change Clothes.mp3";
import AdjustClothesMale from "/assets/audio/English/male/104 Adjust Clothes.mp3";
import ChangeUnderwearMale from "/assets/audio/English/male/105 Change Underwear.mp3";
import NeedSocksMale from "/assets/audio/English/male/106 Need Socks.mp3";
import OpenForMeMale from "/assets/audio/English/male/107 Open for Me.mp3";
import PhoneTabletMale from "/assets/audio/English/male/108 Phone or Tablet.mp3";
import PlugInPhoneTabletMale from "/assets/audio/English/male/109 Plug in Phone or Tablet.mp3";

import ChargeHearingAidsMale from "/assets/audio/English/male/110 Charge Hearing Aids.mp3";
import InhalerBreathingTreatmentMale from "/assets/audio/English/male/111 Inhaler or Breathing Treatment.mp3";
import BloodSugarMale from "/assets/audio/English/male/112 Blood Sugar.mp3";
import BloodPressureMale from "/assets/audio/English/male/113 Blood Pressure.mp3";
import HelmetMale from "/assets/audio/English/male/114 Helmet.mp3";
import CervicalCollarMale from "/assets/audio/English/male/115 Cervical Collar.mp3";
import NurseMale from "/assets/audio/English/male/116 Nurse.mp3";
import DoctorMale from "/assets/audio/English/male/117 Doctor.mp3";
import SpeechTherapistMale from "/assets/audio/English/male/119 Speech Therapist.mp3";

import OccupationalPhysicalTherapistMale from "/assets/audio/English/male/120 Occupational or Physical Therapist.mp3";
import RespiratoryTherapistMale from "/assets/audio/English/male/121 Respiratory Therapist.mp3";
import TickleInMyThroatMale from "/assets/audio/English/male/123 Tickle In My Throat.mp3";

import CantSeeLeftMale from "/assets/audio/English/male/19 Can’t See Left.mp3";
import CantSeeRightMale from "/assets/audio/English/male/20 Can’t See Right.mp3";
import HeadacheMale from "/assets/audio/English/male/21 Headache.mp3";
import NeedBatteriesMale from "/assets/audio/English/male/22 Need Batteries.mp3";
import CheckMyHearingMale from "/assets/audio/English/male/23 Check My Hearing.mp3";
import NeedsChargingMale from "/assets/audio/English/male/24 Needs Charging.mp3";
import NeedMyHearingAidsMale from "/assets/audio/English/male/25 Need My Hearing Aids.mp3";
import WriteItDownMale from "/assets/audio/English/male/27 Write it Down.mp3";
import StrokeSymptomsMale from "../../../public/assets/audio/English/male/StrokeSymptoms.mp3";
import GoodOrOkayMale from "/assets/audio/English/male/29 Good or Okay.mp3";

import ALittleOffMale from "/assets/audio/English/male/30 A little off.mp3";
import NotGoodMale from "/assets/audio/English/male/31 Not good.mp3";
import LowOrSadMale from "/assets/audio/English/male/32 Low or Sad.mp3";
import VeryDownMale from "/assets/audio/English/male/33 Very Down.mp3";
import WorriedGuiltyMale from "/assets/audio/English/male/35 Worried or Guilty.mp3";
import EveningNightMale from "/assets/audio/English/male/37 Evening _ Night.mp3";
import FeedingTubeRemovedMale from "/assets/audio/English/male/38 Feeding Tube Removed.mp3";
import EatingAndDrinkingMale from "/assets/audio/English/male/39 Eating and Drinking.mp3";

import FoodAllergyMale from "/assets/audio/English/male/40 Food Allergy.mp3";
import HungryThirstyMale from "/assets/audio/English/male/41 Hungry or Thirsty.mp3";
import DontEatThisMale from "/assets/audio/English/male/42 Don’t Eat This.mp3";
import NotAllowedToEatOrDrinkMale from "/assets/audio/English/male/43 Not Allowed to Eat or Drink.mp3";
import WrongTrayMale from "/assets/audio/English/male/44 Wrong Tray.mp3";
import SpecialDietMale from "/assets/audio/English/male/45 Special Diet.mp3";
import VegetarianVeganMale from "/assets/audio/English/male/46 Vegetarian _ Vegan.mp3";
import NoDairyMale from "/assets/audio/English/male/47 No Dairy.mp3";
import KosherMale from "/assets/audio/English/male/48 Kosher.mp3";
import HalalMale from "/assets/audio/English/male/49 Halal.mp3";

import GlutenFreeMale from "/assets/audio/English/male/50 Gluten-Free.mp3";
import NutFreeMale from "/assets/audio/English/male/51 Nut-Free.mp3";
import LowSodiumMale from "/assets/audio/English/male/52 Low Sodium.mp3";
import DiabeticCarbControlledMale from "/assets/audio/English/male/53.mp3";
import TextureModifiedMale from "/assets/audio/English/male/54 Texture Modified.mp3";
import MovementMale from "/assets/audio/English/male/56 Movement.mp3";
import CommunicationThinkingMale from "/assets/audio/English/male/57 Communication or Thinking.mp3";
import NoVoiceMale from "/assets/audio/English/male/58 No Voice.mp3";
import HardToUnderstandYouMale from "/assets/audio/English/male/59 Hard to Understand You.mp3";

import CantFindMyWordsMale from "/assets/audio/English/male/60 Can’t Find My Words.mp3";
import HardToTalkMale from "/assets/audio/English/male/61 Hard to Talk.mp3";
import ImConfusedMale from "/assets/audio/English/male/62 I’m Confused.mp3";
import WrongWordsComeOutMale from "/assets/audio/English/male/63 Wrong Words Come Out.mp3";
import DontKnowWhereIAmMale from "/assets/audio/English/male/64 Don’t Know Where I Am.mp3";
import MemoryTroubleMale from "/assets/audio/English/male/65 Memory Trouble.mp3";
import WeaknessMale from "/assets/audio/English/male/66 Weakness.mp3";
import WeakOnOneSideMale from "/assets/audio/English/male/67 Weak on One Side.mp3";
import ClumsyOffBalanceMale from "/assets/audio/English/male/68 Clumsy _ Off Balance.mp3";
import NeedChangedMale from "/assets/audio/English/male/7 Need Changed.mp3";
import NoConcernsMale from "/assets/audio/English/male/70 No Concerns.mp3";
import WithTransferRepositioningMale from "/assets/audio/English/male/74 With Transfer _ Repositioning.mp3";
import WithMovementMale from "/assets/audio/English/male/75 With Movement.mp3";
import WithTubeFeedMale from "/assets/audio/English/male/78 With Tube Feed.mp3";
import WithStressEmotionMale from "/assets/audio/English/male/79 With Stress or Emotion.mp3";
import AfterProcedureMale from "/assets/audio/English/male/80 After Procedure.mp3";
import SinceIllnessMale from "/assets/audio/English/male/82 Since Illness.mp3";
import AlwaysChronicMale from "/assets/audio/English/male/86 Always _ Chronic.mp3";
import BathroomMale from "/assets/audio/English/male/87 Bathroom.mp3";
import BedMale from "/assets/audio/English/male/88 Bed.mp3";
import FoodMale from "/assets/audio/English/male/89 Food.mp3";
import DrinkMale from "/assets/audio/English/male/90 Drink.mp3";
import PainMedsMale from "/assets/audio/English/male/91 Pain Meds.mp3";
import RepositionMale from "/assets/audio/English/male/92 Reposition.mp3";
import IceMale from "/assets/audio/English/male/93 Ice.mp3";
import IcePackMale from "/assets/audio/English/male/94 Ice Pack.mp3";
import BlanketPillowMale from "/assets/audio/English/male/96 Blanket or Pillow.mp3";
import RoomTemperatureMale from "/assets/audio/English/male/97 Room Temperature.mp3";
import TissueMale from "/assets/audio/English/male/98 Tissue.mp3";
import LightsMale from "/assets/audio/English/male/99 Lights.mp3";
import AfterMealsMale from "/assets/audio/English/male/After Meals.mp3";
import BrainFogMale from "/assets/audio/English/male/Brain Fog.mp3";
import GetsWorseThroughTheDayMale from "/assets/audio/English/male/Gets Worse Through the Day.mp3";
import HeatingPadMale from "/assets/audio/English/male/Heating Pad.mp3";
import LostWeightWithoutTryingMale from "/assets/audio/English/male/Lost Weight Without Trying.mp3";
import NeedHelpEatingMale from "/assets/audio/English/male/Need Help Eating.mp3";
import NursingAideMale from "/assets/audio/English/male/Nursing Aide.mp3";
import SinceFallInjuryMale from "/assets/audio/English/male/Since Fall or Injury.mp3";
import SinceMyStrokeInjuryMale from "/assets/audio/English/male/Since My Stroke or Injury.mp3";
import TroubleWalkingMale from "/assets/audio/English/male/Trouble Walking.mp3";
import WhenEatingDrinkingMale from "/assets/audio/English/male/When Eating _ Drinking.mp3";
import WhenLyingDownMale from "/assets/audio/English/male/When Lying Down.mp3";
import WhenSleepingMale from "/assets/audio/English/male/When Sleeping.mp3";
import WhenSwallowingMale from "/assets/audio/English/male/When Swallowing.mp3";
import WhenToiletingMale from "/assets/audio/English/male/When Toileting.mp3";
import WhenWalkingMale from "/assets/audio/English/male/When Walking.mp3";
import WithMentalActivityMale from "/assets/audio/English/male/With Mental Activity.mp3";

import LostHearingAidsMale from "/assets/audio/English/male/26 Lost Hearing Aids.mp3";
import JustFatigueMale from "/assets/audio/English/male/Just Fatigue.mp3";
import WithPillsMale from "/assets/audio/English/male/With Pills.mp3";
import WithDrinksMale from "/assets/audio/English/male/With Drinks.mp3";
import ConstipationMale from "/assets/audio/English/male/Constipation.mp3";

import Lapuertemale from "/assets/audio/spanish/male/VO - La puerte.mp3";
import NecesitounaPajitaSpanishmale from "/assets/audio/spanish/male/VO - Necesito una Pajita.mp3";
import BlancoSpanishMale from "/assets/audio/English/male/Blanco (white).mp3";
import AmarilloSpanishMale from "/assets/audio/spanish/male/Amarillo (yellow).mp3";
import MarronSpanishMale from "/assets/audio/English/male/Marron (Brown).mp3";
import VerdeSpanishMale from "/assets/audio/spanish/male/Verde.mp3";
import AplastadoSpanishMale from "/assets/audio/spanish/male/Aplastado.mp3";
import EnteroSpanishMale from "/assets/audio/spanish/male/Entero.mp3";
import AlergiaAlimentariaSpanishMale from "/assets/audio/spanish/male/40 Alergia alimentaria.mp3";
import DificultadParaEscribirSpanishMale from "/assets/audio/spanish/male/VO -  Dificultad para Escribir.mp3";
import DificultadParaLeerSpanishMale from "/assets/audio/spanish/male/VO - Dificultad para leer.mp3";
import RepartidosEnElTiempoSpanishMale from "/assets/audio/spanish/male/Repartidos en el tiempo.mp3";
import TiemposDiferentesDifferentTimesSpanishMale from "../../../public/assets/audio/spanish/male/tiempos diferentes_different times(Joaquin Vignoli).mp3";
import MedicamentosParaElDolorProgramadosScheduledPainMedsSpanishMale from "/assets/audio/spanish/male/medicamentos para el dolor programados_scheduled pain meds (Joaquin Vignoli).mp3";
import WithFoodAndDrinkConComidaYBebidaSpanishMale from "/assets/audio/spanish/male/with food and drink_con comida y bebida.mp3";
import LiquidoSpanishMale from "/assets/audio/English/male/liquido.m4a";
import WithFoodAndDrinksMale from "/assets/audio/English/male/With Food _ Drinks.mp3";
import MaloSpanishMale from "/assets/audio/spanish/male/Malo.mp3";
import EstaBienSpanishMale from "/assets/audio/spanish/male/Esta bien.mp3";
import BuenoSpanishMale from "/assets/audio/spanish/male/Bueno (Joaquin Vignoli).mp3";
import GettingWorseEmpeorandoSpanishMale from "../../../public/assets/audio/spanish/male/getting worse_empeorandoMale.mp3";
import GettingBetterMejorandoSpanishMale from "/assets/audio/spanish/male/getting better_mejorando.mp3";
import UpAndDownArribaYAbajoSpanishMale from "/assets/audio/spanish/male/up and down_arriba y abajo.mp3";
import NoSeSpanishMale from "/assets/audio/spanish/male/VO - No se.mp3";
import LoMismoSpanishMale from "/assets/audio/spanish/male/Lo mismo.mp3";
import GoodMale from "/assets/audio/English/male/Good.mp3";
import UpAndDownMale from "/assets/audio/spanish/male/Up and Down.mp3";
...
import BlurryBorrosoSpanishMale from "/assets/audio/spanish/male/blurry_borroso.mp3";
import DoubleDobleSpanishMale from "/assets/audio/spanish/male/double_doble.mp3";
import CateterSpanishMale from "/assets/audio/spanish/male/Cateter.mp3";
import MuyPocoOConPocaFrecuenciaSpanishMale from "/assets/audio/spanish/male/Muy poco o con poca frecuencia.mp3";
import UrgencyUrgenciaSpanishMale from "/assets/audio/spanish/male/urgency_urgencia.mp3";
import FrequentFrequenteSpanishMale from "/assets/audio/spanish/male/frequent_frequente.mp3";
import FrequentMale from "/assets/audio/English/male/Frequent.mp3";
import VeryLittleOrInfrequentMale from "/assets/audio/English/male/Very Little or Infrequent.mp3";
import UrgencyMale from "/assets/audio/English/male/Urgency.mp3";
import GoteandoLeakingSpanishMale from "/assets/audio/spanish/male/Goteando (Leaking).mp3";
import QuitarRemoveSpanishMale from "/assets/audio/spanish/male/Quitar_Remove 2.mp3";
import JustNauseaMale from "/assets/audio/English/male/8 Just Nausea.mp3";
import VomitingMale from "/assets/audio/spanish/male/Vomiting.mp3";
import InformationMale from "/assets/audio/English/male/Information.mp3";
import TooLittleMale from "/assets/audio/English/male/Too Little.mp3";
import DolorDeOidoEarPainSpanishMale from "/assets/audio/spanish/male/Dolor de Oido (Ear Pain).mp3";
import WithActivityHowOftenMale from "/assets/audio/spanish/male/With Activity(How Often)_com (1).mp3";
import WakeUpTiredMale from "/assets/audio/English/male/Wake Up Tired.mp3";
import TroubleSleepingMale from "/assets/audio/English/male/Trouble Sleeping.mp3";
import AllDayFatigueMale from "/assets/audio/spanish/male/All Day(Fatigue).mp3";
import BrainTiredMale from "/assets/audio/English/male/Brain Tired.mp3";
import MoreThanUsualMale from "/assets/audio/spanish/male/More Than Usual_com.mp3";
import ChokingBreathingProblemsMale from "/assets/audio/spanish/male/Choking(Breathing Problems)_com.mp3";
import ChestPainMale from "/assets/audio/English/male/Chest Pain.mp3";
import ShortnessOfBreathMale from "/assets/audio/English/male/Shortness of Breath.mp3";
import BloodUrinationMale from "/assets/audio/English/male/Blood(Urination).mp3";
import DiarrheaMale from "/assets/audio/English/male/Diarrhea.mp3";
import BreathingOrCoughingEnglishMale from "/assets/audio/spanish/male/Breathing or Coughing_com.mp3";
import NoConcernsEnglishMale from "/assets/audio/English/male/70 No Concerns.mp3";
import PainUrinationEnglishMale from "/assets/audio/English/male/Pain.mp3";
import CommunicationThinkingEnglishMale from "/assets/audio/English/male/57 Communication or Thinking.mp3";
import MovementEnglishMale from "/assets/audio/English/male/56 Movement.mp3";
import MedicationEnglishMale from "/assets/audio/English/male/Medication.mp3";
import EatingAndDrinkingEnglishMale from "/assets/audio/English/male/39 Eating and Drinking.mp3";
import FatigueEnglishMale from "/assets/audio/spanish/male/Fatigue_com.mp3";
import NauseaEnglishMale from "/assets/audio/English/male/Nausea.mp3";
import UrinationEnglishMale from "/assets/audio/English/male/Urination.mp3";
import BowelsEnglishMale from "/assets/audio/English/male/Bowels.mp3";
import SwallowingEnglishMale from "/assets/audio/spanish/male/Swallowing_com.mp3";
import WithMedicationMale from "/assets/audio/spanish/male/With Medication(Fatigue)_com.mp3";
import WithActivityMale from "/assets/audio/spanish/male/With Activity(How Often)_com.mp3";
import MorningMale from "/assets/audio/English/male/Morning.mp3";
import AllDayMale from "/assets/audio/spanish/male/All Day(Fatigue).mp3";
import ComesAndGoesMale from "/assets/audio/spanish/male/Comes and Goes_com.mp3";
import MildMale from "/assets/audio/spanish/male/Mild_com.mp3";
import ModerateMale from "/assets/audio/English/male/Moderate.mp3";
import NoPainMale from "/assets/audio/English/male/No Pain.mp3";
import SevereMale from "/assets/audio/spanish/male/Severe_com.mp3";
import VerySevereMale from "/assets/audio/spanish/male/Very Severe_com.mp3";
import SpasmingMale from "/assets/audio/English/male/Spasming.mp3";
import NumborTingling_comMale from "/assets/audio/English/male/Numb _ Tingling.mp3";
import SharporStabbing_comMale from "/assets/audio/English/male/Sharp _ Stabbing.mp3";
import AchingorDull_comMale from "/assets/audio/English/male/Aching _ Dull.mp3";
import BurningMale from "/assets/audio/spanish/male/Burning(Urination)_com.mp3";
import SqueezingTightMale from "/assets/audio/English/male/Squeezing _ Tight.mp3";
import BrainTiredmale from "/assets/audio/English/male/Brain Tired.mp3";
import BreathingTreatmentmale from "/assets/audio/English/male/breathing treatment.mp3";

import ConMovimientoMale from "/assets/audio/spanish/male/75 Con movimiento.mp3";
// spanish male
import TalVezMaleSpanish from "/assets/audio/spanish/male/34 Tal vez.mp3";

import ComezonSpanishMale from "/assets/audio/spanish/male/Comezon.mp3";
import CrampingCalambresSpanishMale from "/assets/audio/spanish/male/cramping_calambres.mp3";
import DisparandoSpanishMale from "/assets/audio/spanish/male/Disparando.mp3";
import DoloridoOSordoSpanishMale from "/assets/audio/spanish/male/Dolorido o sordo.mp3";
import HeavyPesadoSpanishMale from "/assets/audio/spanish/male/Heavy_pesado.mp3";
import SpasmingEspasmosSpanishMale from "/assets/audio/spanish/male/spasming_espasmos.mp3";
import SqueezingOrTightApretandoOApretadoSpanishMale from "/assets/audio/spanish/male/squeezing or tight_apretando o apretado.mp3";
import ThrobbingPalpitanteSpanishMale from "/assets/audio/spanish/male/throbbing_palpitante.mp3";

import MildLeveSpanishMale from "/assets/audio/spanish/male/mild_leve.mp3";
import ModerateModeradoSpanishMale from "/assets/audio/spanish/male/moderate_moderado.mp3";
import NoPainSinDolorSpanishMale from "/assets/audio/spanish/male/No pain_sin dolor.mp3";
import SevereGraveSpanishMale from "/assets/audio/spanish/male/severe_grave.mp3";
import WorstPainImaginablePeorDolorImaginableSpanishMale from "/assets/audio/spanish/male/worst pain imaginable_peor dolor imaginable.mp3";

import AlDormirMale from "/assets/audio/spanish/male/72 Al dormir.mp3";
import AlCaminarMale from "/assets/audio/spanish/male/73 Al caminar.mp3";
import AlTransferirOReposicionarMale from "/assets/audio/spanish/male/74 Al transferir o reposicionar.mp3";

import AlUsarElBanoMale from "/assets/audio/spanish/male/76 Al usar el baño.mp3";
import ConAlimentacionPorTuboMale from "/assets/audio/spanish/male/78 Con alimentación por tubo.mp3";

import ConEstresOEmocionMale from "/assets/audio/spanish/male/79 Con estrés o emoción.mp3";
import DespuesDeUnProcedimientoMale from "/assets/audio/spanish/male/80 Después de un procedimiento.mp3";
import DesdeMiDerrameCerebralOLesionMale from "/assets/audio/spanish/male/81 Desde mi derrame cerebral o lesión .mp3";
import DesdeLaEnfermedadMale from "/assets/audio/spanish/male/82 Desde la enfermedad.mp3";
import DesdeLaCaidaOLesionMale from "/assets/audio/spanish/male/83 Desde la caída o lesión.mp3";

import AlTragarMale from "/assets/audio/spanish/male/84 Al tragar.mp3";
import AlComerOBeberMale from "/assets/audio/spanish/male/85 Al comer o beber.mp3";
import SiempreOCronicoMale from "/assets/audio/spanish/male/86 Siempre o crónico.mp3";
import AlEstarSentadoV2Male from "/assets/audio/spanish/male/Al estar sentado v2.mp3";
import ConActividadMale from "/assets/audio/spanish/male/con actividad.mp3";
import ConActividadMentalMale from "/assets/audio/spanish/male/Con actividad mental.mp3";

import ConMedicacionMale from "/assets/audio/spanish/male/con medicacion.mp3";

import DespuesDeComerMale from "/assets/audio/spanish/male/Despues de comer (1).mp3";
import EmpeoraALoLargoDelDiaMale from "/assets/audio/spanish/male/Empeora a lo largo del dia.mp3";
import MananaMorningMale from "/assets/audio/spanish/male/Mañana - morning.mp3";
import NocheTempranoEveningMale from "../../../public/assets/audio/spanish/male/Noche Temprano - eveningMale.mp3";

import RecienComenzadoMale from "/assets/audio/spanish/male/Recien Comenzado.mp3";
import TodoElDiaMale from "/assets/audio/spanish/male/todo el dia.mp3";
import AlEstarDePieMale from "/assets/audio/spanish/male/VO - Al Estar de Pie.mp3";
import NoSeMale from "/assets/audio/spanish/male/VO - No se.mp3";
import VieneYVaMale from "/assets/audio/spanish/male/VO - Viene y Va.mp3";

import TardeAfternoonSpanishMale from "/assets/audio/spanish/male/Tarde - afternoon.mp3";

import burning_quemaSpanishFemale from "/assets/audio/spanish/male/burning_quema.mp3";
import MuygraveSpanishMale from "/assets/audio/spanish/male/very severe_muy grave.mp3";

import HormigueodolorosoSpanishFemale from "/assets/audio/spanish/male/Hormigueo doloroso.mp3";

import sharporstabbing_afiladoopunzanteSpanishFemale from "/assets/audio/spanish/male/sharp or stabbing_afilado o punzante.mp3";
import numbortinglingSpanishFemale from "/assets/audio/spanish/male/numb or tingling_entumecimiento u hormigueo.mp3";

import AlgoMasSpanishMale from "/assets/audio/spanish/male/algo mas.mp3";
import TraqueotomiaTrachSpanishMale from "/assets/audio/spanish/male/Traqueotomia (Trach).mp3";
import TuboDeAlimentacionV2SpanishMale from "/assets/audio/spanish/male/Tubo de alimentacion v2.mp3";
import ComunicacionPensamientoSpanishMale from "/assets/audio/spanish/male/57 Comunicación o pensamiento.mp3";
import MovimientoSpanishMale from "/assets/audio/spanish/male/56 Movimiento.mp3";
import MiccionSpanishMale from "/assets/audio/spanish/male/Micción (Joaquin Vignoli).mp3";
import EmotionsFeelingsEmocionesSentimientosSpanishMale from "/assets/audio/spanish/male/Emotions_Feelings Emociones_sentimientos.mp3";
import ComerYBeberSpanishMale from "/assets/audio/spanish/male/39 Comer y beber.mp3";
import MedicacionSpanishMale from "/assets/audio/spanish/male/Medicación  (Joaquin Vignoli).mp3";
import FatigaSpanishMale from "/assets/audio/spanish/male/Fatiga .mp3";
import IntestinosBowelsSpanishMale from "/assets/audio/spanish/male/Intestinos (Bowels).mp3";
import NauseasNauseaSpanishMale from "/assets/audio/spanish/male/Nauseas (Nausea).mp3";

import RespirationTosBreathingCoughingSpanishMale from "/assets/audio/spanish/male/Respiración_Tos (Breathing_Coughing).mp3";
import DolorPainSpanishMale from "/assets/audio/spanish/male/Dolor (Pain).mp3";
import MucosidadSecrecionesMucusSecretionsSpanishMale from "/assets/audio/spanish/male/mucosidad_secreciones_mucus_secretions.mp3";
import HeridaIncisionWoundIncisionSpanishMale from "/assets/audio/spanish/male/Herida_Incision (Wound_Incision).mp3";
import AlgoPasoSpanishMale from "/assets/audio/spanish/male/algo paso.mp3";
import EnfermedadSpanishMale from "/assets/audio/spanish/male/Enfermedad.mp3";
import OidoSpanishMale from "/assets/audio/spanish/male/Oido.mp3";
import VisionSpanishMale from "/assets/audio/spanish/male/Vision.mp3";
import SinPreocupacionesSpanishMale from "/assets/audio/spanish/male/70 Sin preocupaciones .mp3";

import ComidaSpanishMale from "/assets/audio/spanish/male/Comida.mp3";
import AlcoholSpanishMale from "/assets/audio/spanish/male/Alcohol.mp3";
import CriarALosNinosSpanishMale from "/assets/audio/spanish/male/Criar a los niños.mp3";
import FamiliaSpanishMale from "/assets/audio/spanish/male/Familia.mp3";
import SexoSpanishMale from "/assets/audio/spanish/male/Sexo.mp3";
import ActividadDeLaComunidadV2SpanishMale from "/assets/audio/spanish/male/Actividad de la comunidad v2.mp3";
import TrabajoSpanishMale from "/assets/audio/spanish/male/VO - Trabajo.mp3";
import ActividadDelHogarV2SpanishMale from "/assets/audio/spanish/male/Actividad del hogar v2.mp3";
import CitasDeSeguimientoV2SpanishMale from "/assets/audio/spanish/male/Citas de seguimiento v2.mp3";
import DineroSpanishMale from "/assets/audio/spanish/male/Dinero.mp3";
import ApoyoDeLaFamiliaV2SpanishMale from "/assets/audio/spanish/male/Apoyo de la familia v2.mp3";
import PrevencionDeAccidentesCerebrovascularesV2SpanishMale from "/assets/audio/spanish/male/Prevencion de accidentes cerebrovasculares v2.mp3";
import ConfiguracionDelHogarV2SpanishMale from "/assets/audio/spanish/male/Configuracion del hogar v2.mp3";
import ConduciendoSpanishMale from "/assets/audio/spanish/male/Conduciendo.mp3";
import ComunicacionV2SpanishMale from "/assets/audio/spanish/male/Comunicacion v2.mp3";
import TerapiaSpanishMale from "/assets/audio/spanish/male/Terapia.mp3";
import MejorareSpanishMale from "/assets/audio/spanish/male/Mejorare.mp3";
import DarDeAltaSpanishMale from "/assets/audio/spanish/male/Dar de Alta.mp3";
import QueMePasoWhatHappenedToMeSpanishMale from "/assets/audio/spanish/male/¿Que me paso_ (What happened to me_).mp3";

import NoQuieroDontWantSpanishMale from "/assets/audio/spanish/male/No Quiero (Don_t Want).mp3";
import CambiosDeSaborTasteChangesSpanishMale from "/assets/audio/spanish/male/Cambios de sabor (Taste Changes).mp3";
import MeSientoLlenoAFeelFullSpanishMale from "/assets/audio/spanish/male/Me Siento Lleno_a (Feel Full).mp3";
import OlorDeComidaSmellOfFoodSpanishMale from "/assets/audio/spanish/male/Olor de comida (Smell of Food).mp3";

import DiarrheaDiarreaSpanishMale from "/assets/audio/spanish/male/diarrhea_diarrea.mp3";
import GasHinchazonSpanishMale from "/assets/audio/spanish/male/Gas _ Hinchazon.mp3";
import SangreSpanishMale from "/assets/audio/spanish/male/Sangre.mp3";
import BandejaDeCamaSpanishMale from "/assets/audio/spanish/male/Bandeja de cama.mp3";
import BolsaDeColostomiaSpanishMale from "/assets/audio/spanish/male/9 Bolsa de colostomía.mp3";
import EstrenimientoSpanishMale from "/assets/audio/spanish/male/Estreñimiento.mp3";
...
import NarizCongestionadaQueMoaqueaCongestedRunnyNoseSpanishMale from "/assets/audio/spanish/male/Nariz congestionada_que moquea (Congested_Runny Nose).mp3";
import CPAPBiPAPSpanishMale from "../../../public/assets/audio/spanish/male/CPAP_BiPAP (CPAP_BiPAP).mp3";

import AnxiousAnsiosoSpanishMale from "/assets/audio/spanish/male/Anxious_Ansioso.mp3";
import PreocupadaOConCulpaSpanishMale from "/assets/audio/spanish/male/35 Preocupada o con culpa.mp3";
import SinEsperanzaSpanishMale from "/assets/audio/spanish/male/36 Sin esperanza.mp3";
import PenaGriefSpanishMale from "/assets/audio/spanish/male/Pena (Grief).mp3";

import AgotadoExhaustedSpanishMale from "/assets/audio/spanish/male/agotado_exhausted.mp3";
import FrustradoFrustratedSpanishMale from "/assets/audio/spanish/male/frustrado_frustrated.mp3";
import EnojadoAngrySpanishMale from "/assets/audio/spanish/male/enojado_angry.mp3";
import AsustadoScaredSpanishMale from "/assets/audio/spanish/male/asustado_scared.mp3";
import DeprimidoDepressedSpanishMale from "/assets/audio/spanish/male/deprimido_depressed.mp3";

import DespertarCansadoSpanishMale from "/assets/audio/spanish/male/Despertar cansado.mp3";
import DespuesDeUnProcedimientoSpanishMale from "/assets/audio/spanish/male/80 Después de un procedimiento.mp3";
import MasDeLoHabitualSpanishMale from "/assets/audio/spanish/male/mas de lo habitual.mp3";
import ConActividadSpanishMale from "/assets/audio/spanish/male/con actividad.mp3";
import CerebroCansadoSpanishMale from "/assets/audio/spanish/male/Cerebro Cansado.mp3";

import EmpeoraALoLargoDelDiaSpanishMale from "/assets/audio/spanish/male/Empeora a lo largo del dia.mp3";
import ProblemasParaDormirSpanishMale from "/assets/audio/spanish/male/problemas para dormir.mp3";

import ApetitoSpanishMale from "/assets/audio/spanish/male/Apetito (Appetite).mp3";

import NauseasVomitosNauseaVomitingSpanishMale from "/assets/audio/spanish/male/Nauseas_Vomitos (Nausea_Vomiting).mp3";
import DolorDeGargantaSoreThroatSpanishMale from "/assets/audio/spanish/male/Dolor de garganta (Sore Throat).mp3";
import AdoloridoAAcheySpanishMale from "/assets/audio/spanish/male/Adolorido_a (achey) male.mp3";
import EscalofriosChillsSpanishMale from "/assets/audio/spanish/male/Escalofrios (Chills).mp3";
import FiebreFeverSpanishMale from "/assets/audio/spanish/male/Fiebre (Fever).mp3";

import TapadosPluggedSpanishMale from "/assets/audio/spanish/male/Tapados (Plugged).mp3";
import MareadoADizzySpanishMale from "/assets/audio/spanish/male/Mareado_a (Dizzy).mp3";
import SonandoRingingSpanishMale from "/assets/audio/spanish/male/Sonando (Ringing).mp3";
import NoPuedoOirCantHearSpanishMale from "/assets/audio/spanish/male/No Puedo Oir (Can_t Hear).mp3";
import AudifonosSpanishMale from "/assets/audio/spanish/male/Audifonos.mp3";

import TiempoTimingSpanishMale from "/assets/audio/spanish/male/tiempo_timing(Joaquin Vignoli).mp3";
import DemasiadosSpanishMale from "/assets/audio/spanish/male/Demasiados.mp3";
import MuyPocoTooLittleSpanishMale from "/assets/audio/spanish/male/muy poco_too little (Joaquin Vignoli).mp3";
import DificilDeTragarHardToSwallowSpanishMale from "/assets/audio/spanish/male/Dificil de tragar_Hard to Swallow(Joaquin Vignoli).mp3";
import InformacionInformationSpanishMale from "/assets/audio/spanish/male/informacion_information.mp3";
import EfectosSecundariosSideEffectsSpanishMale from "/assets/audio/spanish/male/Efectos Secundarios_Side Effects(Joaquin Vignoli).mp3";

import InodoroOrUrinarioMaleSpanish from "/assets/audio/spanish/male/10 Inodoro o urinario.mp3";
import TelevisorMaleSpanish from "/assets/audio/spanish/male/100 Televisor.mp3";
import MusicaMaleSpanish from "/assets/audio/spanish/male/101 Música.mp3";
import DentadurasMaleSpanish from "/assets/audio/spanish/male/102 Dentaduras.mp3";
import CambiarRopaMaleSpanish from "/assets/audio/spanish/male/103 Cambiar ropa.mp3";
import AjustarRopaMaleSpanish from "/assets/audio/spanish/male/104 Ajustar ropa.mp3";
import CambiarRopaInteriorMaleSpanish from "/assets/audio/spanish/male/105 Cambiar ropa interior.mp3";
import NecesitoCalcetinesMaleSpanish from "/assets/audio/spanish/male/106 Necesito calcetines.mp3";
import AbreloPorMiMaleSpanish from "/assets/audio/spanish/male/107 Ábrelo por mí.mp3";
import TelefonoOrTabletaMaleSpanish from "/assets/audio/spanish/male/108 Teléfono o tableta.mp3";
import ConectarTelefonoTabletaMaleSpanish from "/assets/audio/spanish/male/109 Conectar teléfono o tableta.mp3";
import InsomnioMaleSpanish from "/assets/audio/spanish/male/11 Insomnio.mp3";
import CargarAudifonosMaleSpanish from "/assets/audio/spanish/male/110 Cargar audífonos.mp3";
import InhaladorOrTratamientoRespiratorioMaleSpanish from "/assets/audio/spanish/male/111 Inhalador o tratamiento respiratorio.mp3";
import AzucarEnSangreMaleSpanish from "/assets/audio/spanish/male/112 Azúcar en sangre.mp3";
import PresionArterialMaleSpanish from "/assets/audio/spanish/male/113 Presión arterial.mp3";
import CascoMaleSpanish from "/assets/audio/spanish/male/114 Casco.mp3";
import CollarCervicalMaleSpanish from "/assets/audio/spanish/male/115 Collar cervical.mp3";
import EnfermeraMaleSpanish from "/assets/audio/spanish/male/116 Enfermera.mp3";
import DoctorMaleSpanish from "/assets/audio/spanish/male/117 Doctor.mp3";
import AsistenteEnfermeriaMaleSpanish from "/assets/audio/spanish/male/118 Asistente de enfermería.mp3";
import TerapeutaHablaMaleSpanish from "/assets/audio/spanish/male/119 Terapeuta del habla.mp3";
import RuidosoMaleSpanish from "/assets/audio/spanish/male/12 Ruidoso.mp3";
import TerapeutaOcupacionalFisicoMaleSpanish from "/assets/audio/spanish/male/120 Terapeuta ocupacional o físico.mp3";
import TerapeutaRespiratorioMaleSpanish from "/assets/audio/spanish/male/121 Terapeuta respiratorio.mp3";
import BajePesoSinIntentarloMaleSpanish from "/assets/audio/spanish/male/122 Bajé de peso sin intentarlo.mp3";
import CosquilleoGargantaMaleSpanish from "/assets/audio/spanish/male/123 Cosquilleo en la garganta.mp3";
import SoloFatigaMaleSpanish from "/assets/audio/spanish/male/124 solo fatiga.mp3";
import DemasiadaLuzMaleSpanish from "/assets/audio/spanish/male/13 Demasiada luz.mp3";
import InterrupcionesMaleSpanish from "/assets/audio/spanish/male/14 Interrupciones.mp3";
import PerdiMisGafasMaleSpanish from "/assets/audio/spanish/male/15 Perdí mis gafas.mp3";
import NoFuncionaRotoMaleSpanish from "/assets/audio/spanish/male/16 No funciona o está roto.mp3";
import NecesitoMisGafasMaleSpanish from "/assets/audio/spanish/male/17 Necesito mis gafas.mp3";
import RevisarMiVisionMaleSpanish from "/assets/audio/spanish/male/18 Revisar mi visión.mp3";
import NoPuedoVerIzquierdaMaleSpanish from "/assets/audio/spanish/male/19 No puedo ver a la izquierda.mp3";
import SoloSecoIncomodoMaleSpanish from "/assets/audio/spanish/male/2 Solo seco o incómodo.mp3";
import NoPuedoVerDerechaMaleSpanish from "/assets/audio/spanish/male/20 No puedo ver a la derecha.mp3";
import DolorCabezaMaleSpanish from "/assets/audio/spanish/male/21 Dolor de cabeza.mp3";
import NecesitaBateriasMaleSpanish from "/assets/audio/spanish/male/22 Necesita baterías.mp3";
import RevisarMiAudicionMaleSpanish from "/assets/audio/spanish/male/23 Revisar mi audición.mp3";
import NecesitaCargarseMaleSpanish from "/assets/audio/spanish/male/24 Necesita cargarse.mp3";
import NecesitoMisAudifonosMaleSpanish from "/assets/audio/spanish/male/25 Necesito mis audífonos.mp3";
import PerdiMisAudifonosMaleSpanish from "/assets/audio/spanish/male/26 Perdí mis audífonos.mp3";
import EscribeloMaleSpanish from "/assets/audio/spanish/male/27 Escríbelo.mp3";
import SintomasAccidenteCerebrovascularMaleSpanish from "/assets/audio/spanish/male/28 Síntomas de un accidente cerebrovascular.mp3";
import BienOrEnOrdenMaleSpanish from "/assets/audio/spanish/male/29 Bien o en orden.mp3";
import SoloAlTragarMaleSpanish from "/assets/audio/spanish/male/3 Solo al tragar.mp3";
import UnPocoRaroMaleSpanish from "/assets/audio/spanish/male/30 Un poco raro.mp3";
import NoBienMaleSpanish from "/assets/audio/spanish/male/31 No bien.mp3";
import DeprimidoTristeMaleSpanish from "/assets/audio/spanish/male/32 Deprimido o triste.mp3";
import MuyDeprimidoMaleSpanish from "/assets/audio/spanish/male/33 Muy deprimido.mp3";

import PreocupadaCulpaMaleSpanish from "/assets/audio/spanish/male/35 Preocupada o con culpa.mp3";
import SinEsperanzaMaleSpanish from "/assets/audio/spanish/male/36 Sin esperanza.mp3";
import TardeNocheMaleSpanish from "/assets/audio/spanish/male/37 En la tarde o la noche.mp3";
import TuboAlimentacionRetiradaMaleSpanish from "/assets/audio/spanish/male/38 Tubo de alimentación retirada.mp3";
import ComerBeberMaleSpanish from "/assets/audio/spanish/male/39 Comer y beber.mp3";
import AlergiaMedicamentosMaleSpanish from "/assets/audio/spanish/male/4 Alergia a medicamentos.mp3";
import AlergiaAlimentariaMaleSpanish from "/assets/audio/spanish/male/40 Alergia alimentaria.mp3";
import HambreSedMaleSpanish from "/assets/audio/spanish/male/41 Con hambre o sed.mp3";
import NoComerEstoMaleSpanish from "/assets/audio/spanish/male/42 No comer esto.mp3";
import NoPermitidoComerBeberMaleSpanish from "/assets/audio/spanish/male/43 No se permite comer o beber .mp3";
import BandejaEquivocadaMaleSpanish from "/assets/audio/spanish/male/44 Bandeja equivocada.mp3";
import DietaEspecialMaleSpanish from "/assets/audio/spanish/male/45 Dieta especial.mp3";
import VegetarianaVeganaMaleSpanish from "/assets/audio/spanish/male/46 Vegetariana o vegana.mp3";
import SinLacteosMaleSpanish from "/assets/audio/spanish/male/47 Sin lácteos.mp3";
import KosherMaleSpanish from "/assets/audio/spanish/male/48 Kosher.mp3";
import HalalMaleSpanish from "/assets/audio/spanish/male/49 Halal.mp3";
import ReflujoMaleSpanish from "/assets/audio/spanish/male/5 Reflujo.mp3";
import SinGlutenMaleSpanish from "/assets/audio/spanish/male/50 Sin gluten.mp3";
import SinFrutosSecosMaleSpanish from "/assets/audio/spanish/male/51 Sin frutos secos.mp3";
import BajoSodioMaleSpanish from "/assets/audio/spanish/male/52 Bajo en sodio.mp3";
import ParaDiabeticosMaleSpanish from "/assets/audio/spanish/male/53 Para diabéticos.mp3";
import TexturaModificadaMaleSpanish from "/assets/audio/spanish/male/54 Textura modificada.mp3";
import NecesitoAyudaComerMaleSpanish from "/assets/audio/spanish/male/55 Necesito ayuda para comer.mp3";
import MovimientoMaleSpanish from "/assets/audio/spanish/male/56 Movimiento.mp3";
import ComunicacionPensamientoMaleSpanish from "/assets/audio/spanish/male/57 Comunicación o pensamiento.mp3";
import SinVozMaleSpanish from "/assets/audio/spanish/male/58 Sin voz.mp3";
import DificilEntenderMaleSpanish from "/assets/audio/spanish/male/59 Difícil de entender.mp3";
import TuboAlimentacionMaleSpanish from "/assets/audio/spanish/male/6 Tubo de alimentación.mp3";
import NoEncuentroPalabrasMaleSpanish from "/assets/audio/spanish/male/60 No encuentro las palabras.mp3";
import DificilHablarMaleSpanish from "/assets/audio/spanish/male/61 Difícil hablar.mp3";
import EstoyConfundidaMaleSpanish from "/assets/audio/spanish/male/62 Estoy confundida.mp3";
import SalenPalabrasEquivocadasMaleSpanish from "/assets/audio/spanish/male/63 Salen palabras equivocadas.mp3";
import NoSeDondeEstoyMaleSpanish from "/assets/audio/spanish/male/64 No sé dónde estoy.mp3";
import ProblemasMemoriaMaleSpanish from "/assets/audio/spanish/male/65 Problemas de memoria.mp3";
import DebilidadMaleSpanish from "/assets/audio/spanish/male/66 Debilidad.mp3";
import DebilUnLadoMaleSpanish from "/assets/audio/spanish/male/67 Débil de un lado.mp3";
import TorpeSinEquilibrioMaleSpanish from "/assets/audio/spanish/male/68 Torpe o sin equilibrio.mp3";
import ProblemasCaminarMaleSpanish from "/assets/audio/spanish/male/69 Problemas al caminar.mp3";
import NecesitaCambioMaleSpanish from "/assets/audio/spanish/male/7 Necesita cambio.mp3";
import SinPreocupacionesMaleSpanish from "/assets/audio/spanish/male/70 Sin preocupaciones .mp3";
import AlAcostarseMaleSpanish from "/assets/audio/spanish/male/71 Al acostarse.mp3";
import AlDormirMaleSpanish from "/assets/audio/spanish/male/72 Al dormir.mp3";
import AlCaminarMaleSpanish from "/assets/audio/spanish/male/73 Al caminar.mp3";
import AlTransferirReposicionarMaleSpanish from "/assets/audio/spanish/male/74 Al transferir o reposicionar.mp3";
import ConMovimientoMaleSpanish from "/assets/audio/spanish/male/75 Con movimiento.mp3";
import AlUsarBanoMaleSpanish from "/assets/audio/spanish/male/76 Al usar el baño.mp3";
import ConAzucarPresionSangreMaleSpanish from "/assets/audio/spanish/male/77 Con azúcar o presión en sangre.mp3";
import ConAlimentacionTuboMaleSpanish from "/assets/audio/spanish/male/78 Con alimentación por tubo.mp3";
import ConEstresEmocionMaleSpanish from "/assets/audio/spanish/male/79 Con estrés o emoción.mp3";
import SoloNauseasMaleSpanish from "/assets/audio/spanish/male/8 Solo náuseas.mp3";
import DespuesProcedimientoMaleSpanish from "/assets/audio/spanish/male/80 Después de un procedimiento.mp3";
import DesdeDerrameCerebralLesionMaleSpanish from "/assets/audio/spanish/male/81 Desde mi derrame cerebral o lesión .mp3";
import DesdeEnfermedadMaleSpanish from "/assets/audio/spanish/male/82 Desde la enfermedad.mp3";
import DesdeCaidaLesionMaleSpanish from "/assets/audio/spanish/male/83 Desde la caída o lesión.mp3";
import AlTragarMaleSpanish from "/assets/audio/spanish/male/84 Al tragar.mp3";
import AlComerBeberMaleSpanish from "/assets/audio/spanish/male/85 Al comer o beber.mp3";
import SiempreCronicoMaleSpanish from "/assets/audio/spanish/male/86 Siempre o crónico.mp3";
import BanoMaleSpanish from "/assets/audio/spanish/male/87 Baño.mp3";
import CamaMaleSpanish from "/assets/audio/spanish/male/88 Cama.mp3";
import ComidaMaleSpanish from "/assets/audio/spanish/male/89 Comida.mp3";
import BolsaColostomiaMaleSpanish from "/assets/audio/spanish/male/9 Bolsa de colostomía.mp3";
import BebidaMaleSpanish from "/assets/audio/spanish/male/90 Bebida.mp3";
import MedicamentosDolorMaleSpanish from "/assets/audio/spanish/male/91 Medicamentos para el dolor.mp3";
import ReposicionarMaleSpanish from "/assets/audio/spanish/male/92 Reposicionar.mp3";
import HieloMaleSpanish from "/assets/audio/spanish/male/93 Hielo.mp3";
import BolsaHieloMaleSpanish from "/assets/audio/spanish/male/94 Bolsa de hielo.mp3";
import AlmohadillaTermicaMaleSpanish from "/assets/audio/spanish/male/95 Almohadilla térmica.mp3";
import MantaAlmohadaMaleSpanish from "/assets/audio/spanish/male/96 Manta o almohada.mp3";
import TemperaturaHabitacionMaleSpanish from "/assets/audio/spanish/male/97 Temperatura de la habitación.mp3";
import PanueloMaleSpanish from "/assets/audio/spanish/male/98 Pañuelo.mp3";
import LucesMaleSpanish from "/assets/audio/spanish/male/99 Luces.mp3";
import Pesado_GruesoMale from "/assets/audio/spanish/male/Pesado_Grueso (Heavy_Thick).mp3";

import CerebroCansadoMaleSpanish from "/assets/audio/spanish/male/Cerebro Cansado.mp3";
import ConActividadMentalMaleSpanish from "/assets/audio/spanish/male/Con actividad mental.mp3";
import DespuesComerMaleSpanish from "/assets/audio/spanish/male/Despues de comer (1).mp3";
import EmpeoraLargoDiaMaleSpanish from "/assets/audio/spanish/male/Empeora a lo largo del dia.mp3";
import NieblaMentalMaleSpanish from "/assets/audio/spanish/male/Niebla Mental.mp3";

import CanulaSpanishMale from "/assets/audio/spanish/male/Cánula.mp3";
import PicazonSpanishMale from "/assets/audio/spanish/male/Picazon.mp3";
import ApretadoSpanishMale from "/assets/audio/spanish/male/Apretado.mp3";
import ValvulaParlanteSpanishMale from "/assets/audio/spanish/male/Valvula Parlante.mp3";
import SintomasDeUnAccidenteCerebrovascularSpanishMale from "/assets/audio/spanish/male/28 Síntomas de un accidente cerebrovascular.mp3";
import TraqueostomiaQuitadoSpanishMale from "/assets/audio/spanish/male/Traqueostomia quitado.mp3";
import TuboDeAlimentacionQuitadoSpanishMale from "/assets/audio/spanish/male/Tubo de alimentacion quitado.mp3";
import EsperarDemasiadoTiempoWaitedTooLongSpanishMale from "/assets/audio/spanish/male/Esperar Demasiado Tiempo (Waited Too Long).mp3";
import MalToqueSpanishMale from "/assets/audio/spanish/male/Mal toque.mp3";
import NecesitaCambioSpanishMale from "/assets/audio/spanish/male/7 Necesita cambio.mp3";
import AnalisisDeSangreORayosXBloodworkXraySpanishMale from "/assets/audio/spanish/male/Analisis de Sangre o Rayos X (Bloodwork_Xray).mp3";
import ArgumentoSpanishMale from "/assets/audio/spanish/male/Argumento (argument).mp3";
import CaerseFallSpanishMale from "/assets/audio/spanish/male/Caerse (Fall).mp3";
import SoloNauseasSpanishMale from "/assets/audio/spanish/male/8 Solo náuseas.mp3";
import VomitingVomitosSpanishMale from "/assets/audio/spanish/male/vomiting_vomitos.mp3";
import BocaSecaSpanishMale from "/assets/audio/spanish/male/Boca seca.mp3";
